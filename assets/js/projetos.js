function projetos(section) {
  ...
  <div class="content">
    <div class="cards">
      ...
      <div class="card">
        <h3>Site do Terceirão</h3>
        <div class="img-wrapper">
          <img src="./assets/images/project1.png" alt="Imagem do projeto Site do Terceirão" />
        ...
        <p>Site oficial desenvolvido para o Terceiro Ano da Escola Zezé Lima, com informações e recursos para os alunos.</p>
      ...
      <div class="card">
        ...
        <p>Desafio de 7 dias para criação de um projeto.</p>
        <p class="languages">JavaScript</p>
        <h3> EM BREVE </h3>
        <p class="desafios_link">
            Por <a href="https://www.alura.com.br/" target="_blank"><strong>Alura</strong></a>
          </p>
